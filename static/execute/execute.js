...
$('document').ready(function() {
    ...
    for (var i=0; i<experiment_data_by_type.artifact.length; i++) {
        ...
        if (artifact.properties.hasOwnProperty("opmw:wasGeneratedBy") && artifact.properties["opmw:wasGeneratedBy"] !== null && artifact.properties["opmw:wasGeneratedBy"] !== undefined) {
            var generating_step = experiment_data_by_template_uri[artifact.properties["opmw:wasGeneratedBy"]];
            console.log(artifact.properties["opmw:correspondsToTemplateArtifact"], "generated by");
            artifact.properties["opmw:wasGeneratedBy"] = generating_step;
            if (generating_step != null && generating_step != undefined) {
                generating_step["opmw:wasGeneratedBy"].push(artifact);
            }
        } else {
            console.log(artifact.properties["opmw:correspondsToTemplateArtifact"], "not generated by");
        }
    }
...
var make_diagram_data = function() {
    ...
    _.each(experiment_data_by_type.artifact, function(artifact) {
        ...
        if (artifact.properties.hasOwnProperty("opmw:wasGeneratedBy")) {
            if (artifact.properties["opmw:wasGeneratedBy"] !== undefined && artifact.properties["opmw:wasGeneratedBy"] !== null) {
